...
const HeliosPoint = koffi.struct('HeliosPoint', {
  x: 'uint16',
  y: 'uint16',
  r: 'uint8',
  g: 'uint8',
...
const libPath = path
  .join(__dirname, '../sdk/libHeliosLaserDAC.dylib')
...
const HeliosLib = {
  OpenDevices: lib.func('OpenDevices', 'int', []),
  GetStatus: lib.func('GetStatus', 'int', ['int']),
  Stop: lib.func('Stop', 'int', ['int']),
  SetShutter: lib.func('SetShutter', 'int', [
    'uint', // device
    'bool', // shutter value
  ]),
  CloseDevices: lib.func('CloseDevices', 'void', []),
  WriteFrame: lib.func('WriteFrame', 'int', [
    'int', // device
    'int', // pps
    'int', // flags - 0 output immediately, 1 output at the end of the frame
    koffi.pointer(HeliosPoint), // point data
    'int', // point count
  ]),
};
